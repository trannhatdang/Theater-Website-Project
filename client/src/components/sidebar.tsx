		...
		<motion.div className='bg-slate-700 h-screen' animate={{width: open ? 120 : 70}}>
			<Stack>
				...
				*/}
				...
				{open ? <p className='text-cyan-500'>home</p> : <HomeIcon className='text-cyan-500'/>}
				</Button>
				<Button component={Link} to="/employee">
				{open ? <p className='text-cyan-500'>employee</p> : <PeopleIcon className='text-cyan-500'/>}
				</Button>
				<Button component={Link} to="/film">
				{open ? <p className='text-cyan-500'>film</p> : <TheatersIcon className='text-cyan-500'/>}
				</Button>
				<Button component={Link} to="/promotion">
				{open ? <p className='text-cyan-500'>promotion</p> : <LoyaltyIcon className='text-cyan-500'/>}
				</Button>
				<Button component={Link} to="/event">
				{open ? <p className='text-cyan-500'>event</p> : <CelebrationIcon className='text-cyan-500'/>}
				</Button>
			</Stack>
		</motion.div>
	)
