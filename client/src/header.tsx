export default function Header(){
	return (
	<header class = 'flex bg-slate-700'>
		...
		<nav class='flex ml-auto justify-end-safe text-xl font-xs'>
			...
			<a href="./film" class = 'p-1 m-4 hover:text-gray-600 border-violet-600 rounded-md'>Films</a>
			<a href="./event" class = 'p-1 m-4 hover:text-gray-600 border-violet-600 rounded-md'>Events</a>
			<a href="./promotion" class = 'p-1 m-4 hover:text-gray-600 border-violet-600 rounded-md'>Promotions</a>
		</nav>
	</header>
	)
}
